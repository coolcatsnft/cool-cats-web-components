...
export function Milk() {
  return (
    <svg  x="0px" y="0px" viewBox="0 0 197 172">
      <g>
        <g>
          <g>
            <path style={{ fill: '#512E03' }} d="M196.3,78.9c-0.2-5.7-2.1-10.9-4.9-15.7c-1.8-3.1-2.2-6.9-4.6-9.7c-3.9-4.5-6.9-9.6-12-13.1
            ...
            <path style={{ fill: '#FEC877' }} d="M165.4,105.4c-7.2,5.6-16.2,6.6-24.3,9.8c-6.2-0.5-12.5,0.9-18.8-0.7c-2.9-0.7-6-1.3-9.2-1.4
            ...
            <path style={{ fill: '#ECAB49' }} d="M109.6,135.1c-1.9,3.9-3.5,7.7-4.6,11.9c-9.1-1.8-17.7-4.6-26.1-8.8c1.9-4.3,5.4-7.3,6.8-11.8
            C93.5,129.2,101.3,132,109.6,135.1z" />
            <path style={{ fill: '#ECAA48' }} d="M39.2,92.7c-0.9,2.3-2.7,4.2-4.2,6.5c0,1,0,2.2,0,3.2c-1,1.8-3.1,2.7-3.5,5.5c-5.3-6.1-6.3-13.3-9.5-19.6
            c0.2-7-1.1-14.2,2.6-20.9c3.1,3.8,3.8,8.8,6.3,12.9C33.6,84.4,36.2,88.2,39.2,92.7z" />
            <path style={{ fill: '#ECAB49' }} d="M53.6,105.5c3,2.8,5.6,5.7,9.3,7.4c2.8,1.3,5,4,7.3,5.9c-1.2,5-4.8,8.3-6.6,12.6
            c-6.5-3.5-12.5-7.3-18.1-11.8C46.1,117.3,51.5,107.8,53.6,105.5z" />
            <path style={{ fill: '#ECAA48' }} d="M128.8,136.4c2.7,0,5.6-0.3,8.4,0.1c2.6,0.4,5.3,0.4,7.4-0.5c2.7-1.2,5.7,0.6,8.2-2.6
            c-0.4,4.8-4.6,5.8-5.2,9.1c-5,2.7-10.5,3.8-15.4,6.8c-2.9-0.7-6.4,1.4-9.1-1.5C124.6,143.7,126,139.7,128.8,136.4z" />
          </g>
          <g>
            <path style={{ fill: '#512E03' }} d="M98.1,33.3c1,0,2,0,3,0c-0.1,0.6,0.3,1,0.8,1c2.6,0,4.8,1.3,7,2.4c2.5,1.2,4.9,2.5,7.9,2.7
